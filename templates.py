TEMPLATES = {
    "number_one": [
        ...
        # ... add even more (aim for 15–20 per tag) ...
    ],
    "top_ten": [
        ...
        'Not quite #1, but pretty darn close! "{title}" hit #{peak_rank} in {year}. Still in heavy rotation! {emoji}',
        '"{title}" cracked the Top 10 in {year}! Anyone else still blast this in the car? {emoji}',
        'Hot take: #{peak_rank} in {year} was too low for "{title}". Deserved even higher! {emoji}',
        'Raise your hand if "{title}" by {artist} is on your playlist. Top 10 in {year}, eternal hit today. {emoji}',
        'Let\'s be real, "{title}" should\'ve gone all the way—but Top 10 in {year} isn\'t bad! {emoji}',
        'I still remember dancing to "{title}" when it peaked at #{peak_rank} in {year}. What a time. {emoji}',
        '"{title}" by {artist} was one of {year}\'s greatest jams, climbing all the way to #{peak_rank}. {emoji}',
        '"{title}"—I vote we give it a retroactive #1. But hey, Top 10 is legendary! {emoji}',
        # ... keep creatively varying it ...
    ],
    "longevity": [
        ...
        'Chart marathon! "{title}" stuck around for {weeks_on_chart} weeks—talk about a fan favorite. {emoji}',
        ...
        'Do you remember a world before "{title}"? Probably not—{weeks_on_chart} weeks charting! {emoji}',
        '"{title}" was basically the soundtrack of the year. {weeks_on_chart} weeks and still not enough! {emoji}',
    ...
    "short_run": [
        ...
        '"{title}": in and out in {weeks_on_chart} weeks. But hey, sometimes great things come in small, catchy packages! {emoji}',
        '"{title}" didn\'t stick around long—just {weeks_on_chart} weeks—but it made a big impression! {emoji}',
        'Every chart needs its quick-fire sparks: enter "{title}" by {artist}. {weeks_on_chart} weeks of glory. {emoji}',
        'Any other fans of blink-and-you-miss-it hits? "{title}" stayed for {weeks_on_chart} magical weeks. {emoji}',
    ],
    "timeless": [
        ...
        '"{title}" has been around more than 50 years and never gets old. Legends only! {emoji}',
        '"{title}"—if you know, you know. Some tracks, like this one from {year}, age like fine wine! {emoji}',
        ...
        'Sometimes I wish I could hear "{title}" for the first time again. {year} to now, it never left us. {emoji}',
    ],
    "sixties": [
        ...
        '"{title}" captured the spirit of the sixties with every note. {emoji}',
    ...
    "seventies": [
        ...
        '"{title}" lit up dance floors and radios everywhere in {year}. Groove on, {artist}! {emoji}',
    ...
    "eighties": [
        ...
        '"{title}"—{artist} brought the neon to our ears in {year}. Still gets me moving! {emoji}',
        '"{title}" by {artist} feels like a John Hughes montage in song form. Long live the 80s! {emoji}',
        'Turn it up! "{title}" was an 80s must-have, courtesy of {artist}. {emoji}',
    ...
    "nineties": [
        ...
        'Big chords, feel-good vibes: "{title}" defines 90s pop. {artist} nailed it in {year}! {emoji}',
        '"{title}" by {artist}—played endlessly on my boombox. Who else? 90s gold! {emoji}',
        '"{title}" is {year} in a nutshell. All the (baggy) feels! {emoji}',
    ],
    "two_thousands": [
...
FALLBACK_TEMPLATES = [
    ...
    'Who else still listens to "{title}"? That {year} classic by {artist} peaked at #{peak_rank}.',
    '"{title}" reached #{peak_rank} in {year}—and I\'m still obsessed!',
    ...
    'If "{title}" isn\'t an all-timer, what is? Iconic chart run for {artist} in {year}.',
    # ... feel free to expand!
]
